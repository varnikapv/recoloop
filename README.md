...
The design rationale and the measured results are in
[ARCHITECTURE.md](ARCHITECTURE.md). A running log of every defect found during
construction — what caught each one,
